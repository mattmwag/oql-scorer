<div>
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <th>
                @if ($count % 4 != 0)
                <button wire:click="increment(1, 0, 10)">+10</button>
                <button wire:click="increment(1, 0, 5)">+5</button>
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <th>
                @if ($count % 4 != 0)
                <button wire:click="increment(2, 0, 10)">+10</button>
                <button wire:click="increment(2, 0, 5)">+5</button>
